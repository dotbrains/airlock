    ...
    <section className="section alt" id="builder">
      <div className="container">
        ...
        <p className="section-lede">
          The dashboard and the extension both drive one HTTP endpoint. Tune the request here and
          copy the exact <code>curl</code> — plus a plain-English summary of what the runtime will
          do with it.
        </p>
        <div className="builder">
          ...
          <div className="builder-out">
            ...
            {unauth && (
              <div className="warn">
                No token set — the management API is <strong>unauthenticated</strong>. Fine for
                loopback dev; set <code>AIRLOCK_API_TOKEN</code> before exposing Airlock beyond
                localhost.
              </div>
            )}
